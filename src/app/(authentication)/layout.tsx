    ...
    return (
        ...
        <div className="h-screen w-screen flex items-center justify-center p-5">
            <div className={`w-full h-full flex  transition-transform duration-700 rounded-2xl ease-in-out`}>
                ...
                <div className={`bg-[#F4F2FF] rounded-2xl lg:rounded-r-2xl transition-transform duration-700 ease-in-out overflow-hidden p-5 flex justify-center w-full lg:w-2/4 xl:w-3/5`}>{children}</div>
            </div>
        </div>
    )
