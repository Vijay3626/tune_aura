    ...
    return (
        ...
        <div className="h-screen w-screen flex items-center justify-center p-5">
            <div className={`w-full h-full flex  transition-transform duration-700 ease-in-out`}>
                <div className={`bg-primary  hidden lg:block p-5 relative overflow-hidden w-2/5`}>
                ...
                <div className={`bg-[#F4F2FF]   transition-transform duration-700 ease-in-out overflow-hidden p-5 flex justify-center w-3/5`}>{children}</div>
            </div>
        </div>
    )
